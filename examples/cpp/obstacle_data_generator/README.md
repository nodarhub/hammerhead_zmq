This example shows how to read obstacle data sent by Hammerhead. Specifically, it shows how to subscribe to
`ObstacleData` messages, and save that data in `.txt` files in an `obstacle_datas` folder. The header of each generated
file contains information about the order of parameters.
