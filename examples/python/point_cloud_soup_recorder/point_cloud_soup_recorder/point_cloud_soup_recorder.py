...
def write_details_yaml(filename, soup):
    ...
    details = {
        ...
        "projection_type": int(soup.projection_type),
...
class PointCloudSoupRecorder:
    ...
    def _write_point_cloud(self, point_cloud_soup, frame_id):
        ...
        if point_cloud_soup.projection_type != 0:
            ...
            depth3d = reproject_image_to_3d(
                disparity_scaled, point_cloud_soup.projection_type, disparity_to_depth4x4, rotation_matrix,
                point_cloud_soup.focal_length, True, dst=depth3d
            )
            # TODO: The use of self.downsample is not implemented in cylindrical projection.
            xyz = depth3d
            bgr = rectified
        else:
            ...
            # TODO: To merge with parameter q_with_reverse_t_vec of reproject_image_to_3d().
